...
- Filter Logic is now Applied to the Cascading Logic
...
- Defect 25271 Field values were not properly enocded in query parameters of a custom url when exporting to PDF.
- Defect 25399 Custom Views did not work in SQL Server 2017 due to the default compatability level. 
...
- Defect 25557 Cannot open Custom URL/Sub Report on Line/Column/Bar/Area/Combination/WaterFall when a customf field format is applied.
